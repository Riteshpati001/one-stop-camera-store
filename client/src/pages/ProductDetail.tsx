    ...
    <div className="page detail-page">
      ...
      <section className="shell product-detail-layout">
        ...
        <div className="detail-content">
          <p className="eyebrow side-enter side-enter-left"><span className="eyebrow-dot" /> {product.label}</p>
          <h1 className="side-enter side-enter-left side-enter-delay-1">{product.name}</h1>
          <p className="detail-lead side-enter side-enter-right side-enter-delay-2">A representative catalogue entry designed to start the right conversation, not to replace an in-store gear check.</p>
