    ...
    <div className="page quote-page">
      <section className="shell quote-layout">
        <div className="quote-intro">
          <p className="eyebrow"><span className="eyebrow-dot" /> Request a quote</p>
          <h1>Tell us what you are making.</h1>
          <p>A few details make it easier for One Stop to check relevant options, price, and availability before getting back to you.</p>
