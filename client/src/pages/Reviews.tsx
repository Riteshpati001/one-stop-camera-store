...
export default function Reviews() {
  return <div className="page reviews-page">
    <section className="shell review-empty">
      ...
      <h1>Trust should be sourced, not staged.</h1>
      <p>Customer reviews will appear here only after One Stop supplies a legitimate, approved source. This prototype deliberately does not invent testimonials, scores, or customer names.</p>
